...
namespace kursova
{
    public partial class Form1 : Form
    {
        ...
        public class LCDMonitor : Monitor
        {
            ...
            {
                return $"Модель: {Model}, Фірма-виробник: {Manufacturer}, Діагональ: {Diagonal}, Розділова здатність: {Resolution}, Ціна(грн): {Price}, TV-тюнер: {(HasTuner ? "Так" : "Ні")}, Тип матриці: {PanelType}";
            }
        }
        ...
        public class TouchScreenMonitor : Monitor
        {
            ...
            public override string ToString()
            {
                return $"Модель: {Model}, Фірма-виробник: {Manufacturer}, Діагональ: {Diagonal}, Розділова здатність: {Resolution}, Ціна(грн): {Price}, Тип сенсору: {ScreenType}, HDD(гб): {HDDVolume}";
            }
        }
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (listBox1.SelectedIndex != -1)
            {
                ...
                if (selectedMonitor is LCDMonitor)
                {
                    ...
                    radioButton2.Checked = lcdMonitor.HasTuner;
